					...
					<div class="col">
						<section class="card">
							<header class="card-header">
								<h2 class="card-title">Flash News </h2>
							</header>
							<div class="card-body">
								<?php
								...
								<form action="addnews.php" method="POST" onsubmit="return vali();">
									<div class="form-group row">
										<div class="col-lg-12">
											<div class="row">
												<div class="col-lg">
													<label class="control-label text-lg-right pt-2">Flash News<span class="required">*</span></label>
													<input type="text" class="form-control" value="<?php echo $row[0] ?>" name="news" id="news" required>
