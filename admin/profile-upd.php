							...
							<div class="card-body">									
									...
									<div class="form-group row">
										<div class="col-lg-12">
											<div class="row">
												<div class="col-lg">
													<label class="control-label text-lg-right pt-2">Date<span class="required">*</span></label>
									...
									<div class="form-group row">
										<div class="col-lg-12">
											<div class="row">
												<div class="col-lg">
													<label class="control-label text-lg-right pt-2">Add News<span class="required">*</span></label>
